...
namespace StudyDepartment.MVC.Controllers
{
    public class MarksController : Controller
    {
        ...
        public MarksController(StudyDepartmentContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,Name,Value")] Mark mark)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Name,Value")] Mark mark)
        {
            if (id != mark.Id)
            {
                return NotFound();
